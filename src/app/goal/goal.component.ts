...
export class GoalComponent implements OnInit {
  ...
  goals: Goal[] = [
    ...
    new Goal(2, 'Buy Cookies', 'I have to buy cookies for the parrot', new Date(2020, 10, 9)),
    new Goal(3, 'Get new Phone Case', 'Diana has her birthday coming up soon', new Date(2022, 1, 12)),
    new Goal(4, 'Get Dog Food', 'Pupper likes expensive snacks', new Date(2020, 10, 18)),
    new Goal(5, 'Solve math homework', 'Damn Math', new Date(2020, 9, 24)),
